...
[![GitHub stars](https://img.shields.io/github/stars/yourname/claude-code-china-setup?style=social)](https://github.com/yourname/claude-code-china-setup)
...
> **注意**：电脑控制功能需要额外的权限配置，详见 [docs/install.md](docs/install.md)。

## 📋 常见问题速览

| 问题 | 解决方案 |
|------|----------|
| 安装时网络超时 | 执行 `.\scripts\fix_path.ps1` 配置代理 |
| "claude" 命令找不到 | 运行 `.\scripts\fix_path.ps1` 修复 PATH |
...
- [安装指南](docs/install.md) — 详细的安装步骤与环境要求
